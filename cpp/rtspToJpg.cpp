...
GstFlowReturn new_sample(GstAppSink *appsink, gpointer data) {
  ...
  if (true) {
    ...
    g_main_loop_quit (((CustomData *)data)->loop);
    // return GST_FLOW_EOS;
  }
...
int myfunction (int argc, char *argv[], string name, string location, string rtsp)
{
...
// gst-launch-1.0 rtspsrc location=rtsp://admin:seu228228@192.168.1.64 latency=100 \
...
int main (int argc, char *argv[]){
  ...
  string name1 = "1.jpg";
  string name2 = "2.jpg";
  // string rtsp = "rtsp://admin:pass@192.168.1.64/doc/page/preview.asp";
  string rtsp = "rtsp://root:pass@192.168.0.90/axis-media/media.amp"
  // cout<<location<<name<<endl;
  
  myfunction (argc, argv, name1, location, rtsp);
